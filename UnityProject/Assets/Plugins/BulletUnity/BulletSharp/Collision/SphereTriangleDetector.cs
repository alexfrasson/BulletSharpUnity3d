...
namespace BulletSharp
{
	...
	public class SphereTriangleDetector : DiscreteCollisionDetectorInterface
	{
		...
		public SphereTriangleDetector(SphereShape sphere, TriangleShape triangle, double contactBreakingThreshold)
			: base(SphereTriangleDetector_new(sphere._native, triangle._native, contactBreakingThreshold))
		{
		}

		public bool Collide(Vector3 sphereCenter, out Vector3 point, out Vector3 resultNormal, double depth, double timeOfImpact, double contactBreakingThreshold)
		{
		...
		static extern bool SphereTriangleDetector_collide(IntPtr obj, [In] ref Vector3 sphereCenter, [Out] out Vector3 point, [Out] out Vector3 resultNormal, IntPtr depth, IntPtr timeOfImpact, double contactBreakingThreshold);
	}
    */
}
