...
namespace BulletSharp
{
	public class CylinderShape : ConvexInternalShape
	{
        ...
        [DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
        static extern IntPtr btCylinderShape_new2(double halfExtentX, double halfExtentY, double halfExtentZ);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		...
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		static extern double btCylinderShape_getRadius(IntPtr obj);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
	...
	public class CylinderShapeX : CylinderShape
	{
        ...
        [DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
        static extern IntPtr btCylinderShapeX_new2(double halfExtentX, double halfExtentY, double halfExtentZ);
	}
	...
	public class CylinderShapeZ : CylinderShape
	{
        ...
        [DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
        static extern IntPtr btCylinderShapeZ_new2(double halfExtentX, double halfExtentY, double halfExtentZ);
	}
