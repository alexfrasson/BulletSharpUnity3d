...
namespace BulletSharp
{
	public class SphereBoxCollisionAlgorithm : ActivatingCollisionAlgorithm
	{
        ...
        public bool GetSphereDistance(CollisionObjectWrapper boxObjWrap, ref Vector3 v3PointOnBox, ref Vector3 normal, out double penetrationDepth, ref Vector3 v3SphereCenter, double fRadius, double maxContactDistance)
		{
        ...
        public double GetSpherePenetration(ref Vector3 boxHalfExtent, ref Vector3 sphereRelPos, ref Vector3 closestPoint, ref Vector3 normal)
		{
		...
		static extern bool btSphereBoxCollisionAlgorithm_getSphereDistance(IntPtr obj, IntPtr boxObjWrap, [In] ref Vector3 v3PointOnBox, [In] ref Vector3 normal, [Out] out double penetrationDepth, [In] ref Vector3 v3SphereCenter, double fRadius, double maxContactDistance);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		static extern double btSphereBoxCollisionAlgorithm_getSpherePenetration(IntPtr obj, [In] ref Vector3 boxHalfExtent, [In] ref Vector3 sphereRelPos, [In] ref Vector3 closestPoint, [In] ref Vector3 normal);
	}
}
