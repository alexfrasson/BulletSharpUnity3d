...
namespace BulletSharp
{
    public static class MathUtil
    {
        ...
        public static bool CompareFloat(double val1, double val2)
        {
        ...
        [Conditional("DEBUG")]
        public static void SanityCheckFloat(double f)
        {
            Debug.Assert(!double.IsInfinity(f) && !double.IsNaN(f));
        }

        //        public static void Vector3FromFloat(out Vector3 v, double[] fa)
        //        {
        //            v = new Vector3(fa[0], fa[1], fa[2]);
        //        }

        //        //public static void FloatFromVector3(Vector3 v, double[] fa)
        //        //{
        //        //    FloatFromVector3(ref v, fa);
        //        //}

        //        //public static void FloatFromVector3(ref Vector3 v, double[] fa)
        //        //{
        //        //    fa[0] = v.X;
        //        //    fa[1] = v.Y;
        //        //    fa[2] = v.Z;
        ...
        //        //public static double[] FloatFromVector3(Vector3 v)
        //        //{
        //        //    return FloatFromVector3(ref v);
        //        //}

        //        //public static double[] FloatFromVector3(ref Vector3 v)
        //        //{
